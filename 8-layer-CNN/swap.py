...
class CKKSPyfhel(HE):
    def __init__(self, m=2**15, scale=2**30, qi=[31, 30, 30, 30, 30, 30, 30, 30, 30, 30,30, 30, 30, 30, 31]):
        self.he = Pyfhel()
...
if train:
    ...
    torch.save(LeNet1_Approx, "8-layer-swap.pt")
...
lenet_1_approx = torch.load("8-layer-swap.pt", map_location="cpu")
